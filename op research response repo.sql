...
drop table if exists c_research_log;
/* form submission logs */
create table c_research_log(
					-- Section 0
...
insert into c_research_log values(current_timestamp(),"nikhilgup","2022-08-25","NP","Kathmandu","M-12345678912345",true,"Labeling","Mandate Found", "https://", "Country wide","Mandate Not Executable",
null,
...
insert into c_research_log values(current_timestamp(),"burra","2022-08-25","NP","Kathmandu","M-12345678912345",true,"Labeling","Mandate Found", "https://", "Country wide","Mandate Not Executable",
null,
null,null,null,null,null,null,null,
null,
null,null,null,null,null,null,null,
...
Select * from c_research_log;
-- describe c_research_log;
